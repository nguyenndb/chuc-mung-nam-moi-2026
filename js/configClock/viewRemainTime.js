    ...
    this.updateChangeRemainTime = function() {
        ...
        var interval = setInterval(()=>{
            ...
            if(this.remainTime != "NEW_YEAR") {
                ...
                this.x = 0;
                clearInterval(interval); // Dừng đếm ngược thời gian
                
                // Đặt tên cho biến interval này để dễ dàng xóa nó ở case 4
                var intervalText = setInterval(()=>{
                    switch(this.x){
                        ...
                        case 2:
                            ...
                            ++this.x;
                        break;
                        // Hiển thị dãy số 2026
                        case 3:
                            this.elementTime = [2, 0, 2, 6, 36, 36, 36, 36];
                            // SỬA Ở ĐÂY: Chuyển x thành 4 để đi tiếp xuống case 4
                            this.x = 4; 
                        break;
                        case 4:
                            // Dừng hẳn vòng lặp đổi chữ
